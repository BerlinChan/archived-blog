loadPanoStudioViewer = function () {
    ...
    function Jj() {
        Gj();
        var a = (Ii(), new Hi("data:image/gif;base64,R0lGODlhAQABAIAAAP///////yH5BAEKAAEALAAAAAABAAEAAAICTAEAOw\x3d\x3d"));
        this.a =
            new Kj(this, a);
        (E(), this.Bb).className = "gwt-Image"
    }
    ...
    function Oo(a, b) {
        if (b != a.b || a.a != a.c) {
            ...
            case 9:
                Po ||
                    Qo ? c.style[Fb] = "move" : (c.style[Fb] = ea, c.style[Fb] = "url(data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAACAAAAAgCAQAAADZc7J/AAAA" + d + ") 15 15, move");
                break;
            case -1:
                c.style[Fb] = ea;
                break;
    ...
    _.Bc = function (a, b) {
        var c, d;
        this.U.i && "" != this.e ? (this.d && !He(this.d) && (F(this.d, !0), Xr(this)), this.a && He(this.a) && Oj(this.a, (Ii(), new Hi("data:image/gif;base64,R0lGODlhAQABAIAAAP///////yH5BAEKAAEALAAAAAABAAEAAAICTAEAOw\x3d\x3d")))) : this.i && this.a && (d = T(), 2E4 < d - this.U.e.c ? (this.i = !1, this.a && He(this.a) && (Oj(this.a, (Ii(), new Hi("data:image/gif;base64,R0lGODlhAQABAIAAAP///////yH5BAEKAAEALAAAAAABAAEAAAICTAEAOw\x3d\x3d"))), this.b = !1, Tq(this.j, this.b, null, 0))) : (c = 0.6875, 18E3 <= d - this.U.e.c && (c = 176 * (2E4 - (d -
